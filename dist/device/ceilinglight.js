...
class CeilingLight {
    constructor(platform, accessory, device) {
        ...
        this.doCeilingLightUpdate = new rxjs_1.Subject();
        ...
        (0, rxjs_1.interval)(this.deviceRefreshRate * 1000)
            .pipe((0, operators_1.skipWhile)(() => this.ceilingLightUpdateInProgress))
            .subscribe(async () => {
...
//# sourceMappingURL=ceilinglight.js.map