...
class Motion {
    constructor(platform, accessory, device) {
        ...
        (0, rxjs_1.interval)(this.deviceRefreshRate * 1000)
            .pipe((0, operators_1.skipWhile)(() => this.motionUbpdateInProgress))
            .subscribe(async () => {
                ...
                return await this.retry({
                    ...
                    fn: async () => {
                        ...
                        switchbot.onadvertisement = async (ad) => {
                            ...
                            this.debugLog(`${this.device.deviceType}: ${this.accessory.displayName} movement: ${ad.serviceData.movement},`
