...
class Contact {
    constructor(platform, accessory, device) {
        ...
        (0, rxjs_1.interval)(this.deviceRefreshRate * 1000)
            .pipe((0, operators_1.skipWhile)(() => this.contactUbpdateInProgress))
            .subscribe(async () => {
        ...
        if (switchbot !== false) {
            await switchbot
                ...
                switchbot.onadvertisement = async (ad) => {
                    ...
                    this.debugLog(`${this.device.deviceType}: ${this.accessory.displayName} movement: ${ad.serviceData.movement}, doorState: ` +
