...
class IOSensor {
    constructor(platform, accessory, device) {
        ...
        this.doIOSensorUpdate = new rxjs_1.Subject();
        ...
        (0, rxjs_1.interval)(this.deviceRefreshRate * 1000)
            .pipe((0, operators_1.skipWhile)(() => this.ioSensorUpdateInProgress))
            .subscribe(async () => {
...
exports.IOSensor = IOSensor;
//# sourceMappingURL=iosensor.js.map