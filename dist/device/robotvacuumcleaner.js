...
exports.RobotVacuumCleaner = void 0;
...
class RobotVacuumCleaner {
    constructor(platform, accessory, device) {
        ...
        this.doRobotVacuumCleanerUpdate = new rxjs_1.Subject();
        ...
        (0, rxjs_1.interval)(this.deviceRefreshRate * 1000)
            .pipe((0, operators_1.skipWhile)(() => this.robotVacuumCleanerUpdateInProgress))
            .subscribe(async () => {
        ...
        if (switchbot !== false) {
            switchbot
                ...
                switchbot.onadvertisement = async (ad) => {
                    ...
                    this.debugLog(`${this.device.deviceType}: ${this.accessory.displayName} state: ${ad.serviceData.state}, ` +
...
exports.RobotVacuumCleaner = RobotVacuumCleaner;
//# sourceMappingURL=robotvacuumcleaner.js.map